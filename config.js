...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/a/ABEaA9p.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~0ee0f92e7d48fc63684d3723178b1f19:722b3151776733623846493d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'N1z4r;M0h4;0;https://imgur.com/a/ABEaA9p.jpeg;https://chat.whatsapp.com/CiympyaErPL1H1dz0uSfHE',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'N1z4r - ⵣ;N1z4r - bot;https://imgur.com/a/ABEaA9p.jpeg' : process.env.AUDIO_DATA,
